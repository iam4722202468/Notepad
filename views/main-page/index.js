    ...
    return (
      <div>
        ...
        <div className={style.moveRight}>
          <h5>Viewing Notes</h5>
          <p>Notes can be viewed in the <b>View a note</b> tab. Each note has a name, ID, date created/edited and character length field, as well as buttons to edit, delete and download the note.</p>
          ...
          <p>Notes can be created in the <b>Create a note</b> tab. Once a note has been created the name of it can't be edited, but the value of it can be. Every edit will result in an updated edit time on the note.</p>
